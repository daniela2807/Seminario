...
class PreguntasQuiz3Activity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_preguntas_quiz3)

        mUsername = intent.getStringExtra(Constantes.USER_NAME)

        mPreguntasList = Constantes.getPreguntasCategoria3()
